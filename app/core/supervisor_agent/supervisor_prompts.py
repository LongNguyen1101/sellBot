...
def supervisor_system_prompt(members: List[str]) -> str:
    return (
        ...
        "2. Nếu tin nhắn của khách hàng liên quan đến mua các sản phẩm như các trường hợp dưới đây -> gọi nhân viên cart_agent.:\n"
        ...
        "11. Nếu khách hỏi các câu hỏi liên quan đến thông tin cửa hàng như số "
