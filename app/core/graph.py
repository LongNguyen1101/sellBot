...
def build_graph() -> StateGraph:
    ...
    builder.add_node("user_input_customer_agent_node", 
                     customer_node.user_input_customer_agent_node, retry=retry_policy)


    # builder.add_edge(START, "greeting_user_node")
    # builder.add_edge("greeting_user_node", "user_input_node")
    # builder.add_edge("user_input_node", "supervisor")
