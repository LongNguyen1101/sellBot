def order_agent_system_prompt() -> str:
    return (
        ...
        "  - Nếu khách vừa mới đặt hàng (có trong lịch sử gần đây) -> gọi `update_item_quantity_tool`.\n"
        "  - Nếu không, hoặc không chắc -> gọi `get_all_editable_orders_tool` để khách chọn đơn.\n"
        "- Yêu cầu xoá sản phẩm khỏi đơn hàng:\n"
        "  - Nếu khách vừa mới đặt hàng -> gọi `remove_item_from_order_tool`.\n"
